...
White Box:
    Se bazeaza pe cunoasterea logicii interne a codului aplicatiei. Exemplu simplu: pentru un incput avem un output
    asteptat. Daca primim outputul pe care il asteptam PLUS modul in care ajungem al rezultat este cel asteptat,
...
Unit Testing - Component Testing - White Box
    Se concentreaza pe testarea modulului respectiv
...
User Accepta Testing: Black Box
...
Ce este Agile ?
    ...
    propune sa licreze cate putin, frecvent si incremental ( un ciclu de dezvoltare poate sa dureze undeva la 3-4
    saptamani, ideal ) a.i. sa se poate adapta nevoilor de business mai rapid.

Agile Testing Methods:

TDD - Test Driven Development - Proces:
